...
public class RestProviderGenerator extends BaseGenerator<Object> {
    ...
    public void generate() {
        ...
        Collection<RestServiceInfo> restServices = ctx.getRestServices().values();
        for (RestServiceInfo restServiceInfo : restServices) {
            print("import ");
            print(restServiceInfo.getServiceQualifiedName());
            println(";");
        }
        ...
        for (Iterator<RestServiceInfo> iter = restServices.iterator(); iter.hasNext();) {
            RestServiceInfo s = iter.next();
